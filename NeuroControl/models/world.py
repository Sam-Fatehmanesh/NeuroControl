...
class NeuralWorldModel(nn.Module):
    ...
    def forward(self, obs, action, hidden_state):
        ...
        pred_obs_lat, hidden_state = self.state_predictor.forward(obs_lats, hidden_state, action)
        ...
        return decoded_obs, pred_obs_lat, obs_lats, hidden_state, predicted_rewards
